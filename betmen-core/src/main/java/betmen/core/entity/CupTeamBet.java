...
import static betmen.core.entity.CupTeamBet.LOAD_ALL;
import static betmen.core.entity.CupTeamBet.LOAD_ALL_FOR_CUP;
import static betmen.core.entity.CupTeamBet.LOAD_ALL_FOR_CUP_AND_TEAM_AND_USER;
import static betmen.core.entity.CupTeamBet.LOAD_ALL_FOR_CUP_AND_USER;
import static betmen.core.entity.CupTeamBet.LOAD_ALL_FOR_CUP_AND_USER_AND_POSITION;
...
@NamedQueries({
        @NamedQuery(
                name = LOAD_ALL,
                query = "select t from CupTeamBet t order by cupPosition"
        ),
        @NamedQuery(
                name = LOAD_ALL_FOR_CUP,
                query = "select t from CupTeamBet t where cupId= :cupId order by cupPosition"
        ),
        @NamedQuery(
        ...
        @NamedQuery(
                ...
                query = "select t from CupTeamBet t where cupId= :cupId and teamId= :teamId and userId= :userId order by cupPosition"
        ),
        @NamedQuery(
