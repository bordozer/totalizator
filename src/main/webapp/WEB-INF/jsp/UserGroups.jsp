...
<jsp:useBean id="userGroupsModel" type="totalizator.app.controllers.ui.user.groups.UserGroupsModel" scope="request"/>
	...
	<script type="text/javascript">
		...
		require( [ 'jquery', 'js/components/base-view/user-base-page-view', 'js/pages/user-groups/user-groups', 'translator' ], function ( $, Page, userGroups, Translator ) {
			...
			var breadcrumbs = [
				...
				, { link: '/totalizator/users/${user.id}/', title: '${username}' }
