define(function (require) {
    ...
    var matchMessagesWidget = require('js/widgets/match-messages/match-messages-widget');
    ...
    return Backbone.View.extend({
        ...
        render: function () {
            ...
            this._renderMatchMessagesWidget();
        ...
        _renderMatchMessagesWidget: function () {
            var match = this.model.toJSON();
            matchMessagesWidget(this.$('.js-match-messages'), {matchId: match.matchId});
        },
