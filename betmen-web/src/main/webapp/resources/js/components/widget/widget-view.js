define( function ( require ) {
	...
	return Backbone.View.extend( {
		...
		getCupTitle: function( cup, title ) {
			return "<small><a href='/betmen/categories/" + cup.category.categoryId + "/'>" +  cup.category.categoryName + "</a></small>"
					+ ":<small><strong>" + " <a class='text-info' href='/betmen/cups/" + cup.cupId + "/'>" +  cup.cupName + "</a></strong></small> "
					+  ( title ? ' - ' + title : '' );
		},
