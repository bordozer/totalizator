	...
	return WidgetView.extend( {
		...
		getCustomMenuItems: function() {
			...
			var result = [
				...
				, { selector: 'divider' }
				, { selector: 'js-menu-cup-card', icon: 'fa fa-external-link', link: '/betmen/cups/' + model.cupId + '/', text: translator.menuOpenCupCard }
				, { selector: 'js-menu-cup-card', icon: 'fa fa-external-link', link: '/betmen/cups/' + model.cupId + '/matches/', text: translator.menuOpenCupMatchesCard }
				, { selector: 'js-menu-cup-card', icon: 'fa fa-external-link', link: '/betmen/cups/' + model.cupId + '/bets/', text: translator.menuOpenCupBetsCard }
				, { selector: 'js-menu-cup-card', icon: 'fa fa-external-link', link: '/betmen/cups/' + model.cupId + '/winners/bets/', text: translator.menuCupWinnersBetsCard }
				, { selector: 'divider' }
