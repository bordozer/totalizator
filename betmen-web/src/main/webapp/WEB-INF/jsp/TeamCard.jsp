...
<jsp:useBean id="teamCardModel" type="betmen.web.controllers.ui.teams.card.TeamCardModel" scope="request"/>
...
<tags:page>
	...
	<script type="text/javascript">
		...
		require( [ 'jquery', 'js/components/base-view/user-base-page-view', 'js/pages/team-card/team-card' ], function ( $, Page, teamCard ) {
			...
			var breadcrumbs = [
				{ link: '/betmen/sports/' + ${teamCategory.sportKind.id} + '/', title: "${teamCategory.sportKind.sportKindName}" }
				, { link: '/betmen/categories/${teamCategory.id}/', title: '${teamCategory.categoryName}' }
